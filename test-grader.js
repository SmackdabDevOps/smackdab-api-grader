const fs = require('fs');
const { gradeContract } = require('./dist/app/pipeline.js');
...
# Fixed issues 11-14\n`);
    ...
    } else if (result2.grade.total === result1.grade.total) {
      console.log('\n❌ ISSUE: Grader returned same score despite improvements');
      console.log('Spec hashes:');
      console.log(`  v1: ${result1.metadata.specHash}`);
      console.log(`  v2: ${result2.metadata.specHash}`);
    }
